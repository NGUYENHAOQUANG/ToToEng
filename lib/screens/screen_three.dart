...
import 'package:totoeng/screens/screen_four.dart';
...
class _ScreenThreeState extends State<ScreenThree> {
  ...
  List<Map<String, String>> slectedWords = [];
  ...
  void _removeWord(Map<String, String> word) {
    setState(() {
      ...
      slectedWords.remove(word);
    });
  }

  void _checkAnswer() {
    final selected = slectedWords.map((w) => w["translated"]).toList();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Container(
        ...
        child: SafeArea(
          child: shufflewords.isEmpty && slectedWords.isEmpty
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Wrap(
                          spacing: 12,
                          runSpacing: 12,
                          children: slectedWords.map((word) {
                    ...
                    Padding(
                      ...
                      child: SizedBox(
                        width: double.infinity,
                        child: ElevatedButton(
                          onPressed: slectedWords.length == answerEn.length
                              ? _checkAnswer
                              : null,
                          style: ElevatedButton.styleFrom(
                            backgroundColor: greenPrimary,
